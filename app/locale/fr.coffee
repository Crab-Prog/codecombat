...
#    ozaria: "Ozaria"
#    codecombat_blurb: "Notre jeu de codage inédit. Recommandé pour les parents, les particuliers, les enseignants, et les élèves qui veulent faire l'éxpérience d'un des jeux de codage les plus apprécié au monde."
#    ozaria_blurb: " Un jeu d'aventure et de programme informatique où les élèves apprennent à maîtriser la magie perdue du codage pour sauver le monde. Recommandé pour les enseignants et les élèves."
#    try_codecombat: "Essayez CodeCombat"
#    try_ozaria: "Essayez Ozaria"
...
#    my_teachers: "My Teachers"
    ...
    parent: "Parents"
#    esports: "Esports"
#    browser_recommendation: "Pour une meilleure expérience nous vous recommandons d'utiliser la dernière version de Chrome. Télécharger le navigateur ici."
...
#  new_home_faq:
#    what_programming_languages: "Quels langages de programmation sont disponibles?"
#    python_and_javascript: "Nous disposons actuellement de Python et de Javascript."
#    why_python: "Pourquoi devriez-vous choisir Python?"
#    why_python_blurb: "Python est intuitif pour les débutants et actuellement utilisé par de grandes sociétés (telles que Google). Si vous avez de jeunes apprenants, ou des débutants, nous recommandons fortement Python."
#    why_javascript: "Pourquoi devriez-vous choisir JavaScript?"
#    why_javascript_blurb: "JavaScript est le langage qui est utilisé presque sur n'importe quel site web. Vous devriez choisir JavaScript si pour avez pour projet d'étudier aussi le développement web. Nous avons aussi simplifié pour les élèves la transition de Python vers le développement web fondé sur Javascript."
#    javascript_versus_python: "La syntaxe de JavaScript est un peu plus complexe pour les débutants que Python, donc si vous ne savez pas lequel des deux choisir, nous vous recommendons Python."
#    how_do_i_get_started: "Comment est-ce que je commence?"
